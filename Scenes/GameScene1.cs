    ...
    internal class GameScene1 : Component
    {
        ...
        internal override void LoadContent(ContentManager Content)
        {
            ...
            for (int i = 0; i < LEVEL+4; i++)
            {
                ...
                if(i <= 10)
                {
                    ...
                    else if (brickLvlUp % 2 == 0)
                    {
                        if (brickLicznik == 0)
                        {
                            brickCastle[i].brickRect = new Rectangle(70 + 7 * (brickLicznik % 6) + ((brickLicznik % 6) * brickCastle[i].brickTexture.Width * 2 / 3), 535 - brickLvlUp * 9 - brickLvlUp * 30, 70, 40);
                            brickLicznik += 1;
                        }
                        else if (brickLicznik == 5)
                        {
                            brickCastle[i].brickRect = new Rectangle( 3 + 7 * (brickLicznik % 6) + ((brickLicznik % 6) * brickCastle[i].brickTexture.Width * 2 / 3), 535 - brickLvlUp * 9 - brickLvlUp * 30, 70, 40);
                            brickLicznik += 1;
                        ...
                        {
                            brickCastle[i].brickRect = new Rectangle( 7 * (brickLicznik % 6) + ((brickLicznik % 6) * brickCastle[i].brickTexture.Width * 2 / 3), 535 - brickLvlUp * 9 - brickLvlUp * 30, 140, 40);
                            brickLicznik += 1;
                        }
                    }
                }
                ...
                else if(i <=30)
                {
                    ...
                    if (brickLvlUp % 2 == 0)
                    {
                        if(brickLicznik == 0)
                        {                            
                            brickCastle[i].brickRect = new Rectangle(70 + 3 + 7 * (brickLicznik % 4) + ((brickLicznik % 4) * brickCastle[i].brickTexture.Width * 2 / 3), 535 - brickLvlUp * 9 - brickLvlUp * 30, 70, 40);
                            brickLicznik += 1;
                        }
                        else if(brickLicznik == 1 )
                        {
                            brickCastle[i].brickRect = new Rectangle(3 + 7 * (brickLicznik % 4) + ((brickLicznik % 4) * brickCastle[i].brickTexture.Width * 2 / 3), 535 - brickLvlUp * 9 - brickLvlUp * 30, 140, 40);
                            brickLicznik += 1;
                        }
                        else if (brickLicznik == 2)
                        {                            
                            brickCastle[i].brickRect = new Rectangle(280 + 7 * (brickLicznik % 4) + ((brickLicznik % 4) * brickCastle[i].brickTexture.Width * 2 / 3), 535 - brickLvlUp * 9 - brickLvlUp * 30, 140, 40);
                            brickLicznik += 1;
                        }
                        else if(brickLicznik == 3)
                        {
                            brickCastle[i].brickRect = new Rectangle(280 + 3 + 7 * (brickLicznik % 4) + ((brickLicznik % 4) * brickCastle[i].brickTexture.Width * 2 / 3), 535 - brickLvlUp * 9 - brickLvlUp * 30, 70, 40);
                            brickLvlUp += 1;
                            brickLicznik = 0;
                        }
                    }
                    ...
                    else if (brickLvlUp % 2 == 1)
                    {
                        if (brickLicznik == 0)
                        {
                            ...
                            brickCastle[i].brickRect = new Rectangle(70 + 7 * (brickLicznik % 4) + ((brickLicznik % 4) * brickCastle[i].brickTexture.Width * 2 / 3), 535 - brickLvlUp * 9 - brickLvlUp * 30, 140, 40);
                            brickLicznik += 1;
                        }
                        else if (brickLicznik == 1)
                        {
                        ...
                        {
                            brickCastle[i].brickRect = new Rectangle(210 + 3 + 7 * (brickLicznik % 4) + ((brickLicznik % 4) * brickCastle[i].brickTexture.Width * 2 / 3), 535 - brickLvlUp * 9 - brickLvlUp * 30, 140, 40);
                            brickLvlUp += 1;
                            brickLicznik = 0;
                        }
                    }
                ...
                if (brickCastle[i].exist == true && i != 31 && i != 32 && i != 33 && i != 34)
                {                    
            ...
            brickCastle[33].brickRect = new Rectangle(70 + 3, 535 - 7 * 9 - 7 * 30, 210, 40);
            brickCastle[34].brickRect = new Rectangle(460 + 3 * 2 + (brickCastle[34].brickTexture.Width * 2 / 3), 535 - 7 * 9 - 7 * 30, 210, 40);
        ...
        internal override void Update(GameTime gameTime)
        {
            ...
            if (sceneChange == LEVEL+4)
            {
                ...
                SummaryScene.timeSum1 = (int)timer;
